...
```
java -jar /Users/stefan/apps/ili2gpkg-4.8.0/ili2gpkg-4.8.0.jar --dbfile ch.so.awjf.gebiete_efj2.gpkg  --models SO_AWJF_Rahmenmodell_EFJ2_20220818 --modeldir ".;https://models.geo.admin.ch" --export ch.so.awjf.gebiete_efj2.xtf
```
